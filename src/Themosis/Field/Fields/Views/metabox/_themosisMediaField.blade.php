...
<table class="themosis-media">
    <tr>
        <td class="themosis-media-preview <?php if (empty($field['value'])) {
    echo('themosis-media--hidden');
            ...
            <div class="themosis-media-preview-inner">
                ...
                ?>
                <div class="centered">
                    <img class="themosis-media-thumbnail <?php if ($isFile) {
                    echo('icon');
                } ?>" alt="Media Thumbnail" src="{{ $src }}"/>
                </div>
        ...
        <td class="themosis-media-details">
            <div class="themosis-media-inner">
                <div class="themosis-media-infos <?php if (empty($field['value'])) {
                    echo('themosis-media--hidden');
                } ?>">
