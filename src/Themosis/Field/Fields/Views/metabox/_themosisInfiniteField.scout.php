<div class="themosis-infinite-container">
                        ...
                        <table>
                            ...
                            <?php
                                foreach($field['fields'] as $f):
                                    ...
                                    // Render the field.
                                    echo(View::make('_themosisMetaboxRow', array('field' => $f))->render());
    ...
    <div class="themosis-infinite-add-field-container">
        <button type="button" id="themosis-infinite-main-add" class="button-primary">{{ __('Add Row', THEMOSIS_TEXTDOMAIN) }}</button>
    </div>
</div>