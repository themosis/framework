...
class AssetDeprecated implements IAsset
{
    /**
     ...
     * Register the asset.
     *
     * @param AssetDeprecated $asset
     */
    protected function register(AssetDeprecated $asset)
    {
     ...
     * @param AssetDeprecated $asset
     */
    protected function registerScript(AssetDeprecated $asset)
    {
        $args = $asset->getArgs();
     ...
     * @param AssetDeprecated $asset
     */
    protected function registerStyle(AssetDeprecated $asset)
    {
        $args = $asset->getArgs();
     ...
     * @param AssetDeprecated $asset
     */
    protected function registerInline(AssetDeprecated $asset)
    {
        $args = $asset->getArgs();
