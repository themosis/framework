...
trait WordPressUrl
{
     ...
     */
    public function formatUrl(string $url, string $delimiter = 'wp-admin', string $fragment = 'cms'): string
    {
        /**
         ...
         */
        return array_reduce($fragments, function ($carry, $item) {
            return $carry.=$item;
        });
    }
    ...
    /**
     * Format the home URL.
     * Make sure that it does not contain the "/cms" fragment.
     */
    public function formatHomeUrl(string $url, string $fragment = 'cms'): string
    {
     ...
     */
    public function formatSiteUrl(string $url, string $fragment = 'cms'): string
    {
        $length = strlen($fragment) * -1;
     ...
     * fragment, it adds it before the common delimiter.
     */
    public function formatNetworkUrl(string $url, string $delimiter = 'wp-admin', string $fragment = 'cms'): string
    {
