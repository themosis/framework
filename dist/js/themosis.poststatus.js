...
var submitdiv = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#themosis_publish'),
    ...
    post_type = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('input#post_type').val(); // Edit button
...
statusButtons.on('click', function (e) {
  e.preventDefault();
  var button = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this); // If 'ok' button, update label span with status label.
