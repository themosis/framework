...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_components_Manager__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_components_MetaboxFactory__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_components_fields_TextField__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_components_fields_TextareaField__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__metabox_Metabox__ = __webpack_require__(15);
...
var MetaboxFactory = /** @class */ (function () {
    ...
    MetaboxFactory.prototype.make = function (list) {
        for (var idx in list) {
            var selector = '#' + list[idx] + ' .inside';
            //url = themosisGlobal.api.base_url + 'metabox/' + list[idx] + '?post_id=25';
            __WEBPACK_IMPORTED_MODULE_1_react_dom__["render"](__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__metabox_Metabox__["a" /* default */], null), document.querySelector(selector));
            /*axios.get(url)
                .then((response: any) => {
...
var Metabox = /** @class */ (function (_super) {
    ...
    Metabox.prototype.render = function () {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, "Metabox"));
    };
    return Metabox;
